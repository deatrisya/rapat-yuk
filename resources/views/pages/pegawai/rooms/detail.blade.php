    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
                    ...
                    <div class="card-body mt-0">
                        <div class="d-flex">
                            ...
                            <div class="me-2">
                                ...
                                <div class="d-flex">
                                    <span class="badge badge-center rounded-pill bg-label-primary me-2"><i
                                            class="bx bx-user"></i></span>
                                    <p class="text-muted d-block" name="capacity" id="capacity">{{ $room->capacity }} Orang
                                    </p>
                                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card p-2">
                        <div id="calendar-detail-room" class="card-body p-2" data-book="{{ json_encode($events) }}"></div>
                    </div>
                </div>
            </div>
