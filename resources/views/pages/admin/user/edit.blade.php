                ...
                <div class="card-body">
                    <form action="{{ route('users.update',$user->id) }}" method="POST">
                        ...
                        <div class="row mb-3 form-password-toggle">
                            <label class="col-sm-2 col-form-label" for="password">Ganti Password</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="role" id="role2" value="Pegawai" {{ $user->role === 'Pegawai' ? 'checked':''}}>
